...
int bdk_sso_capture(void *buffer, int buffer_size)
{
    ...
    for (core=0; core<num_cores; core++)
    {
        ...
        for (bits=0; bits<8; bits++)
        {
            ...
            if ((load_addr.sstatus.get_cur == 0) && load_addr.sstatus.get_rev)
                ...
                dump->sstatus[core][bits].u64 = bdk_read64_uint64(load_addr.u64);
        }
    }
    ...
    for (index=0; index<num_sso_entries; index++)
    {
        ...
        load_addr.smemload.did = BDK_OCT_DID_TAG_TAG2;
        ...
        for (bits=0; bits<3; bits++)
        {
            ...
            dump->smemload[index][bits].u64 = bdk_read64_uint64(load_addr.u64);
        }
    }
    ...
    for (index=0; index<16; index++)
    {
        ...
        load_addr.sindexload.did = BDK_OCT_DID_TAG_TAG3;
        ...
        for (bits=0; bits<4; bits++)
        {
            ...
            if ((load_addr.sindexload.get_rmt == 0) &&
                ...
                dump->sindexload[index][bits].u64 = bdk_read64_uint64(load_addr.u64);
        }
    }
    return 0;
}
