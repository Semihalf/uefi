...
specific_files = "boot.s platform.c  platform-can.c  platform-eth.c  platform-i2c.c  platform-pio.c  platform-pwm.c  platform-spi.c  platform-timer.c  platform-uart.c"
