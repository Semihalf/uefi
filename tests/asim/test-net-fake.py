...
time.sleep(2)
send("default n0.fake0-n0.fake3")
wait_for("(INS)Command>")
send("count 100")
wait_for("(INS)Command>")
send("start")
...
wait_for("Port N0.FAKE0: tx_packets_total = 100")
wait_for("Port N0.FAKE1: tx_packets_total = 100")
wait_for("Port N0.FAKE2: tx_packets_total = 100")
wait_for("Port N0.FAKE3: tx_packets_total = 100")
wait_for("(INS)Command>")
send("tx_octets_total")
wait_for("Port N0.FAKE0: tx_octets_total = 6000")
wait_for("Port N0.FAKE1: tx_octets_total = 6000")
wait_for("Port N0.FAKE2: tx_octets_total = 6000")
wait_for("Port N0.FAKE3: tx_octets_total = 6000")
wait_for("(INS)Command>")
send("rx_packets_total")
wait_for("Port N0.FAKE0: rx_packets_total = 100")
wait_for("Port N0.FAKE1: rx_packets_total = 100")
wait_for("Port N0.FAKE2: rx_packets_total = 100")
wait_for("Port N0.FAKE3: rx_packets_total = 100")
wait_for("(INS)Command>")
send("rx_octets_total")
wait_for("Port N0.FAKE0: rx_octets_total = 6000")
wait_for("Port N0.FAKE1: rx_octets_total = 6000")
wait_for("Port N0.FAKE2: rx_octets_total = 6000")
wait_for("Port N0.FAKE3: rx_octets_total = 6000")
wait_for("(INS)Command>")
send("rx_validation_errors")
wait_for("Port N0.FAKE0: rx_validation_errors = 0")
wait_for("Port N0.FAKE1: rx_validation_errors = 0")
wait_for("Port N0.FAKE2: rx_validation_errors = 0")
wait_for("Port N0.FAKE3: rx_validation_errors = 0")
wait_for("(INS)Command>")
