...
typedef enum
{
    BDK_SRIO_WRITE_MODE_NWRITE = 0,        /**< Only create NWrite operations */
    BDK_SRIO_WRITE_MODE_NWRITE_RESP = 1,   /**< Create NWrite with response */
    BDK_SRIO_WRITE_MODE_AUTO = 2,          /**< Intelligently breaks writes into multiple transactions based on alignment */
    BDK_SRIO_WRITE_MODE_AUTO_RESP = 3,     /**< BDK_SRIO_WRITE_MODE_WRITE followed with a response */
    BDK_SRIO_WRITE_MODE_MAINTENANCE = 6,   /**< Create a MAINTENANCE transaction. Use bdk_srio_config_write32() instead */
    BDK_SRIO_WRITE_MODE_PORT = 7           /**< Port Write? */
} bdk_srio_write_mode_t;
...
typedef enum
{
    BDK_SRIO_READ_MODE_NORMAL = 0,         /**< Perform a normal read */
    BDK_SRIO_READ_MODE_ATOMIC_SET = 2,     /**< Atomically sets bits in data on remote device */
    BDK_SRIO_READ_MODE_ATOMIC_CLEAR = 3,   /**< Atomically clears bits in data on remote device */
    BDK_SRIO_READ_MODE_ATOMIC_INCREMENT = 4,/**< Atomically increments data on remote device */
    BDK_SRIO_READ_MODE_ATOMIC_DECREMENT = 5,/**< Atomically decrements data on remote device */
    BDK_SRIO_READ_MODE_MAINTENANCE = 6     /**< Create a MAINTENANCE transaction. Use bdk_srio_config_read32() instead */
} bdk_srio_read_mode_t;
...
typedef enum
{
    BDK_SRIO_INITIALIZE_DEBUG = 1,
} bdk_srio_initialize_flags_t;
...
typedef enum
{
    BDK_SRIO_DOORBELL_DONE,    /**< The doorbell is complete */
    BDK_SRIO_DOORBELL_NONE,    /**< There wasn't an outstanding doorbell */
    BDK_SRIO_DOORBELL_BUSY,    /**< The doorbell is still processing */
    BDK_SRIO_DOORBELL_RETRY,   /**< The doorbell needs to be retried */
    BDK_SRIO_DOORBELL_ERROR    /**< The doorbell failed with an error */
} bdk_srio_doorbell_status_t;
 ...
 * @return Zero on success, negative on failure.
 */
int bdk_srio_send_doorbell(int srio_port, int srcid_index, int destid,
