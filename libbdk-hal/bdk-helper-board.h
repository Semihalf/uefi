 ...
 * Internally it uses switch statements based on the bdk_sysinfo
 ...
 */
extern int bdk_helper_board_get_mii_address(int ipd_port);
 ...
 *         return zero.
 */
extern bdk_helper_link_info_t __bdk_helper_board_link_get(int ipd_port);

/**
 * @INTERNAL
 * This function is called by bdk_helper_interface_probe() after it
 ...
 */
extern int __bdk_helper_board_interface_probe(int interface, int supported_ports);

/**
 * @INTERNAL
 * Enable packet input/output from the hardware. This function is
 * called after by bdk_helper_packet_hardware_enable() to
 ...
 * @return Zero on success, negative on failure
 */
extern int __bdk_helper_board_hardware_enable(int interface);
 ...
 */
bdk_helper_board_usb_clock_types_t __bdk_helper_board_usb_get_clock_type(void);
 ...
 *         override.
 */
int __bdk_helper_board_usb_get_num_ports(int supported_ports);
