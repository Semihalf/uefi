...
#define DEFAULT_NAME   "ebb8604"

#define DEFAULT_UDIMM_SPEED  666666666
#define DEFAULT_RDIMM_SPEED  666666666
...
static void setup_dram_custom_lmc_config(ddr3_custom_config_t *cfg, int lmc)
{
    ...
    cfg->fprch2                 = 2;
    cfg->dll_write_offset       = NULL; // was: &generic_dll_write_offset [lmc][0];
    cfg->dll_read_offset        = NULL; // was: &generic_dll_read_offset  [lmc][0];
    cfg->parity                 = 0;
    cfg->rlevel_table		= 0; /* Initialized later */
    cfg->measured_vref		= 0;
}

const dram_config_t *dram_get_config_ebb8604(void)
{
