...
-- Option 2
set_config(octeon.CONFIG_PHY_IF1_PORT0, 256 + 1) -- QLM1 SGMII port 0 PHY address
set_config(octeon.CONFIG_PHY_IF1_PORT1, 256 + 2) -- QLM1 SGMII port 1 PHY address
set_config(octeon.CONFIG_PHY_IF1_PORT2, 256 + 3) -- QLM1 SGMII port 2 PHY address
set_config(octeon.CONFIG_PHY_IF1_PORT3, 256 + 4) -- QLM1 SGMII port 3 PHY address
