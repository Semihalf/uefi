...
local function board_test()
    ...
    node = cavium.MASTER_NODE
    --P3E005++>
    all_pass = check_sata(0) and all_pass -- QLM2, SATA port 0
    all_pass = check_sata(1) and all_pass -- QLM2, SATA port 1
    all_pass = check_sata(2) and all_pass -- QLM2, SATA port 2
    all_pass = check_sata(3) and all_pass -- QLM2, SATA port 3
    all_pass = check_sata(4) and all_pass -- QLM2, SATA port 4
    all_pass = check_sata(5) and all_pass -- QLM3, SATA port 5
    all_pass = check_sata(6) and all_pass -- QLM3, SATA port 6
    all_pass = check_sata(7) and all_pass -- QLM3, SATA port 7
    all_pass = check_sata(8) and all_pass -- QLM3, SATA port 8
    all_pass = check_sata(9) and all_pass -- QLM6, SATA port 9
    all_pass = check_sata(10) and all_pass -- QLM6, SATA port 10
    all_pass = check_sata(11) and all_pass -- QLM6, SATA port 11
    all_pass = check_sata(12) and all_pass -- QLM6, SATA port 12
    all_pass = check_sata(13) and all_pass -- QLM7, SATA port 13
    all_pass = check_sata(14) and all_pass -- QLM7, SATA port 14
    all_pass = check_sata(15) and all_pass -- QLM7, SATA port 15
    --P3E005<+++
  ...
  --P3E005  all_pass = tg_run(tg, "N0.XLAUI1", 60, 100000, 50, 5) and all_pass
    -- Do 100k packets, 1499 bytes each, 50% of gigabit, timeout 7 secs
  --P3E005  all_pass = tg_run(tg, "N0.XLAUI1", 1499, 100000, 50, 7) and all_pass
    -- Do 100k packets, 9212 bytes each, 50% of gigabit, timeout 12 secs
  --P3E005  all_pass = tg_run(tg, "N0.XLAUI1", 9212, 10000, 10, 12) and all_pass
    -- Do 100k packets, 60 bytes each, 50% of gigabit, timeout 5 secs
...
--P3E005++>
    -- Do 100k packets, 60 bytes each, 50% of gigabit, timeout 5 secs
    all_pass = tg_run(tg, "N0.XFI0.1", 60, 100000, 50, 5) and all_pass
    -- Do 100k packets, 1499 bytes each, 50% of gigabit, timeout 7 secs
    all_pass = tg_run(tg, "N0.XFI0.1", 1499, 100000, 50, 7) and all_pass
    -- Do 100k packets, 9212 bytes each, 50% of gigabit, timeout 12 secs
    all_pass = tg_run(tg, "N0.XFI0.1", 9212, 10000, 10, 12) and all_pass
--P3E005<++
--P3E005 +++>//for node 1 phy test
    -- Do 100k packets, 60 bytes each, 50% of gigabit, timeout 5 secs
...
--P3E005++>
    -- Do 100k packets, 60 bytes each, 50% of gigabit, timeout 5 secs
    all_pass = tg_run(tg, "N1.XFI0.1", 60, 100000, 50, 5) and all_pass
    -- Do 100k packets, 1499 bytes each, 50% of gigabit, timeout 7 secs
    all_pass = tg_run(tg, "N1.XFI0.1", 1499, 100000, 50, 7) and all_pass
    -- Do 100k packets, 9212 bytes each, 50% of gigabit, timeout 12 secs
    all_pass = tg_run(tg, "N1.XFI0.1", 9212, 10000, 10, 12) and all_pass
--P3E005<+++
    -- Do 100k packets, 60 bytes each, 50% of gigabit, timeout 5 secs
   --kkdbg all_pass = tg_run(tg, "N1.XFI0.0", 60, 100000, 50, 5) and all_pass
    -- Do 100k packets, 1499 bytes each, 50% of gigabit, timeout 7 secs
   --kkdbg all_pass = tg_run(tg, "N1.XFI0.0", 1499, 100000, 50, 7) and all_pass
    -- Do 100k packets, 9212 bytes each, 50% of gigabit, timeout 12 secs
   --kkdbg all_pass = tg_run(tg, "N1.XFI0.0", 9212, 10000, 10, 12) and all_pass
