...
send("2")
wait_for("Looking for images in /dev/n0.mmc0")
...
wait_for("2) Initialize DRAM using config \"cn88xx-crb-1s\"")
wait_for("3) Configure DRAM clock")
wait_for("4) Run a short DRAM test over the range 64MB-128MB")
wait_for("5) Run a full DRAM test over all memory")
wait_for("6) Main menu")
wait_for("(INS)Menu choice:")
