...
{
    bdk_bar_write(Xhc->bdk_dev, BDK_XHCI_BAR, sizeof(uint32_t), Offset, Data);
}
  ...
  )
{
    ...
    bdk_bar_write(Xhc->bdk_dev, BDK_XHCI_BAR, sizeof(uint32_t), Offset, value);
}
...
{
    bdk_bar_write(Xhc->bdk_dev, BDK_XHCI_BAR, sizeof(uint64_t), Offset, Data);
}
