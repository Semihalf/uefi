...
wait_for("2) Configure DRAM clock")
wait_for("3) Run a short DRAM test over the range 64MB-128MB")
wait_for("4) Run a full DRAM test over all memory")
wait_for("5) Main menu")
wait_for("(INS)Menu choice:")
