...
wait_for("Loading image file '/fatfs/SPI0:/stage1.bin'")
wait_for("Verifying image")
wait_for("Putting all cores except this one in reset")
...
wait_for("Loading image file '/fatfs/SPI0:/stage2.bin'")
wait_for("Verifying image")
wait_for("Putting all cores except this one in reset")
wait_for("Jumping to image at")
wait_for("---")
