 ...
 *
 * @deprecated  This enumeration was used with bdk_pip_config_watcher which has
 *              been deprecated.
 */
typedef enum
{
    BDK_PIP_QOS_WATCH_DISABLE = 0ull,   /**< QoS watcher is diabled */
    BDK_PIP_QOS_WATCH_PROTNH = 1ull,    /**< QoS watcher will match based on the IP protocol */
    BDK_PIP_QOS_WATCH_TCP = 2ull,       /**< QoS watcher will match TCP packets to a specific destination port */
    BDK_PIP_QOS_WATCH_UDP = 3ull        /**< QoS watcher will match UDP packets to a specific destination port */
} bdk_pip_qos_watch_types;
...
typedef union
{
    ...
    struct
    {
        ...
        bdk_pow_tag_type_t         tag_type    : 2;    /**< POW input tag type */
 ...
 *                  of the BDK_PIP_QOS_WATCHX CSR; Pass2 has added a field for
 ...
 */
static inline void bdk_pip_config_watcher(uint64_t watcher,
                                           bdk_pip_qos_watch_types match_type,
                                           uint64_t match_value, uint64_t qos)
{
    bdk_pip_qos_watchx_t watcher_config;
    ...
    BDK_CSR_WRITE(BDK_PIP_QOS_WATCHX(watcher), watcher_config.u64);
}
