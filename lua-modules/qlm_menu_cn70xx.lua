...
function qlm_setup_cn70xx()
    ...
    m:item("xa", "RXAUI   lanes 0-1",              setup_dlm0, octeon.QLM_MODE_RXAUI_1X2,       3125, 0)
    m:item("ss", "SGMII   lane 0, SGMII   lane 1", setup_dlm0, octeon.QLM_MODE_SGMII_SGMII,     2500, 0)
    m:item("sq", "SGMII   lane 0, QSGMII  lane 1", setup_dlm0, octeon.QLM_MODE_SGMII_QSGMII,    2500, 0)
    m:item("sd", "SGMII   lane 0, Disable lane 1", setup_dlm0, octeon.QLM_MODE_SGMII_DISABLED,  2500, 0)
    m:item("qs", "QSGMII  lane 0, SGMII   lane 1", setup_dlm0, octeon.QLM_MODE_QSGMII_SGMII,    2500, 0)
    m:item("qq", "QSGMII  lane 0, QSGMII  lane 1", setup_dlm0, octeon.QLM_MODE_QSGMII_QSGMII,   2500, 0)
    m:item("qd", "QSGMII  lane 0, Disable lane 1", setup_dlm0, octeon.QLM_MODE_QSGMII_DISABLED, 2500, 0)
    m:item("ds", "Disable lane 0, SGMII   lane 1", setup_dlm0, octeon.QLM_MODE_DISABLED_SGMII,  2500, 0)
    m:item("dq", "Disable lane 0, QSGMII  lane 1", setup_dlm0, octeon.QLM_MODE_DISABLED_QSGMII, 2500, 0)
