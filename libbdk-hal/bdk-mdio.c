 ...
 * @param bus_id
 */
static void __bdk_mdio_set_clause45_mode(int bus_id)
{
 ...
 * @param bus_id
 */
static void __bdk_mdio_set_clause22_mode(int bus_id)
{
    bdk_smix_clk_t smi_clk;
 ...
 *         a timeout.
 */
static bdk_smix_rd_dat_t __bdk_mdio_read_rd_dat(int bus_id)
{
 ...
 */
int bdk_mdio_read(int bus_id, int phy_id, int location)
{
 ...
 *         0 on success
 */
int bdk_mdio_write(int bus_id, int phy_id, int location, int val)
{
     bdk_smix_cmd_t smi_cmd;
...
int bdk_mdio_45_read(int bus_id, int phy_id, int device, int location)
{
    bdk_smix_cmd_t smi_cmd;
    bdk_smix_rd_dat_t smi_rd;
    bdk_smix_wr_dat_t smi_wr;
 ...
 *         0 on success
 */
int bdk_mdio_45_write(int bus_id, int phy_id, int device, int location,
                                     int val)
{
    bdk_smix_cmd_t smi_cmd;
    bdk_smix_wr_dat_t smi_wr;
