...
#define DEFAULT_NAME   "inv-p3e003"

//#define DEFAULT_SPEED  933333333
//kkdbg #define DEFAULT_SPEED    667000000
...
const dram_config_t *dram_get_config_inv_p3e003(void)
{
    ...
    else
    {
        ...
        cfg->config[0].dimm_config_table[1].spd_addrs[0] = 0x2051;
        cfg->config[1].dimm_config_table[0].spd_addrs[0] = 0x2052;
        cfg->config[1].dimm_config_table[1].spd_addrs[0] = 0x2053;
        cfg->config[2].dimm_config_table[0].spd_addrs[0] = 0x2054;
        cfg->config[2].dimm_config_table[1].spd_addrs[0] = 0x2055;
        cfg->config[3].dimm_config_table[0].spd_addrs[0] = 0x2056;
        cfg->config[3].dimm_config_table[1].spd_addrs[0] = 0x2057;
    }
