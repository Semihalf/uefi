...
wait_for("Hardware flow control enabled on UART0")
wait_for("Hardware flow control enabled on UART1")
...
wait_for("  1) 0x050000: bdk-cn88xx.bin, version 2014-08-26 15:16:56, 713158 bytes")
