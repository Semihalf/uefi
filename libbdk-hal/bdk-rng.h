 ...
 */
static inline void bdk_rng_enable(void)
{
 ...
 * @return random data
 */
static inline uint8_t bdk_rng_get_random8(void)
{
 ...
 * @return random data
 */
static inline uint16_t bdk_rng_get_random16(void)
{
 ...
 * @return random data
 */
static inline uint32_t bdk_rng_get_random32(void)
{
 ...
 * @return random data
 */
static inline uint64_t bdk_rng_get_random64(void)
{
 ...
 *         1 on error
 */
static inline int bdk_rng_request_random_async(uint64_t scr_addr, uint64_t num_bytes)
{
