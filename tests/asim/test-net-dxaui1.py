...
wait_for("Port N0.DXAUI1: tx_packets_total = 100")
wait_for("(INS)Command>")
send("tx_octets_total")
wait_for("Port N0.DXAUI1: tx_octets_total = 6400")
wait_for("(INS)Command>")
send("rx_packets_total")
wait_for("Port N0.DXAUI1: rx_packets_total = 100")
wait_for("(INS)Command>")
send("rx_octets_total")
wait_for("Port N0.DXAUI1: rx_octets_total = 6400")
wait_for("(INS)Command>")
send("rx_validation_errors")
wait_for("Port N0.DXAUI1: rx_validation_errors = 0")
wait_for("(INS)Command>")
send("default n0.dxaui1")
wait_for("(INS)Command>")
