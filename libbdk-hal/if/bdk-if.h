...
typedef struct
{
    ...
    bdk_if_link_t (*if_link_autoconf)(bdk_if_handle_t handle);
    int (*if_transmit)(bdk_if_handle_t handle, bdk_if_packet_t *packet);
    int (*if_receive)(bdk_if_packet_t *packet);
} __bdk_if_ops_t;
...
extern bdk_if_handle_t bdk_if_get_handle(bdk_if_t iftype, int interface, int index);
...
extern int __bdk_if_transmit_pko(bdk_if_handle_t handle, bdk_if_packet_t *packet);
extern int __bdk_if_receive_sso(bdk_if_packet_t *packet);
